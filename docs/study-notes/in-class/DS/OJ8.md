...
??? question "样例解释 #1"
    ...
    当数组为 $[1]$，第 $⌈1/2⌉$ 大的数就是 $1$ ，当数组为 $[1,2]$，第 $⌈2/2⌉$ 大的数就是 $2$，当数组为 $[1,2,4]$，第 $⌈3/2⌉$ 大的数就是 $2$，当数组为 $[1,2,4,3]$，第 $⌈4/2⌉$ 大的数就是 $3$
...
??? question "样例解释 #2"
    ...
    当数组为 $[1]$，第 $⌈1/3⌉$ 大的数是 $1$，当数组为 $[1,2]$，第 $⌈2/3⌉$ 大的数是 $2$，当数组为 $[1,2,4]$，第 $⌈3/3⌉$ 大的数是 $4$，当数组为 $[1,2,4,3]$，第 $⌈4/3⌉$ 大的数是 $3$，当数组为 $[1,2,4,3,5]$，第 $⌈5/3⌉$ 大的数是 $4$
