...
!!! failure "考虑一些因素，目前闭源了部分的笔记，需要密码"

由此可见，你能找到这里，如果你接下来想继续往下看的话，那你违反了[学术诚信](http://integrity.mit.edu/)，<del>好消息是</del>，我把我的笔记放在这里也违反了[学术诚信](http://integrity.mit.edu/)

我为什么在这里贴上我的笔记？<del>我也不知道</del>，但是我个人认为：
...
3- 如果你是搜索引擎搜关键词搜到了这里（真的会吗？印象里搜索引擎找不到这个网站）：
...
哦忘了说了，我实现的 PA 有 Bug，但是你只有在 PA 4-3 的时候才会意识到

---

附录：

做 PA 4-3 前忘记关 copilot 了，发现 copilot 的训练集里有“圣遗物”，忽然蹦出来的代码震撼我一整年，截了一张图片放在最后
